...
import artist from "../public/1.jpg";
  ...
  <span></span> Get in Touch
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            <div className="space-y-4 lg:space-y-6 text-base lg:text-lg text-gray-600 dark:text-gray-400 font-light leading-relaxed">
              <p>
                Sneha Rai is an visual artist based in Kathmandu, Nepal.
                She likes to work across a wide range of mediums, including
                acrylics, pen & ink, and oils. She loves experimenting with the
                expressive palette knife technique to create texture, depth and
                movement within her pieces. Rather than confining herself to one
                artistic identity, she thrives on the concept of constant
                exploration, challenging herself to discover new ways of
                expression and always infusing her work with a sense of personal
                uniqueness.
              </p>
            </div>
            {/* Credentials */}
